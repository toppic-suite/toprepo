...
def info_merge(mzml_meta_filename, msalign_meta_filename, feature_meta_filename, top_filename, output_file, header_str=None):
    ...
    top_df = top_df.rename(columns={
        ...
        '# Matched masses': "TOPPIC number of matched experimental fragment ions",
        '# Matched fragments': "TOPPIC number of matched theoretical fragment masses", 
        ...
        'Previous amino acid': "TOPPIC previous residue", 
        'Next amino acid': "TOPPIC next residue",
