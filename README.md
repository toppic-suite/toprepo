...
**1.4 Merge the spectral and feature information extracted from msalign and feature files**

This step merges the spectral and feature information extracted in the previous two steps into a single TSV file.
...
**1.5 Merge the spectral information extracted from mzML and msalign files**
...
**1.6 Preprocess TSV file with PrSM identifications reported by TopPIC**

This step preprocesses the TSV file with PrSM identifications and add a "Dataset id" column to the TSV file.
...
**1.7 Merge the spectral information**
...
* Input:
  * toppic_info_filename: A preprocessed TSV file containing spectral identification results reported from TopPIC 
  * mzml_msalign_feature_info_filename: A TSV file containing merged spectral information from mzML, msalign, and feature files 
  * output_tsv_filename: A TSV output file for storing merged spectral information from mzML, msalign, feature files and TopPIC identifications 
