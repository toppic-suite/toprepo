...
**1.5 Merge all spectral information**

This step merges the spectral information obtained from mzML, msalign, and feature files with the spectral identification results generated by TopPIC into a single TSV file. The script is compatible with TSV identification results generated by different TopPIC versions, including TopPIC v1.7.11 and v1.8.1.

* Usage python3 merge_mzml_msalign_toppic_info.py <msalign_info_filename> <feature_info_filename> <toppic_info_filename> <ms_file_info_filename> <output_tsv_filename>
...
```
python3 toprepo/src/process/msalign_anno/merge_msalign_prsm.py --tsv spectra_combined_info.tsv --msalign spectra_preprocess_ms2.msalign --out spectra_prsm_ms2.msalign
```
