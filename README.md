...
**1.4 Merge the spectral and feature information extract from msalign and feature files**

This step merges the spectral information extracted from msalign file and feature information extracted from feature file into a single TSV file.
...
* Input:
   ...
   * feature_info_filename: A TSV file containing MS2 feature information extracted from feature files
...
**1.5 Merge the spectral information extract from mzML and msalign files**
...
**1.7 Merge the spectral information with spectral identification tsv file**
